...
mvn archetype:generate -DarchetypeGroupId=org.kie.kogito -DarchetypeArtifactId=kogito-quarkus-archetype -DarchetypeVersion=1.10.0.Final -DgroupId=com.redhat -DartifactId=my-first-kogito -Dversion=1.0.0-SNAPSHOT