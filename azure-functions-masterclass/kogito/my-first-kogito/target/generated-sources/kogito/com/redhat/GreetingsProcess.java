...
public class GreetingsProcess extends org.kie.kogito.process.impl.AbstractProcess<com.redhat.GreetingsModel> {
    ...
    @Override()
    public com.redhat.GreetingsProcessInstance createInstance(com.redhat.GreetingsModel value) {
        return new com.redhat.GreetingsProcessInstance(this, value, this.createProcessRuntime());
    }

    public com.redhat.GreetingsProcessInstance createInstance(java.lang.String businessKey, com.redhat.GreetingsModel value) {
        return new com.redhat.GreetingsProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public com.redhat.GreetingsModel createModel() {
        return new com.redhat.GreetingsModel();
    }

    public com.redhat.GreetingsProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((com.redhat.GreetingsModel) value);
    }

    public com.redhat.GreetingsProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (com.redhat.GreetingsModel) value);
    }

    public com.redhat.GreetingsProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.redhat.GreetingsProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public com.redhat.GreetingsProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.redhat.GreetingsProcessInstance(this, this.createModel(), wpi);
    }
    ...
    public org.kie.api.definition.process.Process process() {
        ...
        factory.packageName("com.redhat");
